...
%%
%% $Id: slidesSection.tex,v 1.23 2008-06-20 12:42:51 dreuw Exp $
%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Change TOC style - only display sections with page number in \ToC
\setcounter{tocdepth}{1}  % set tocdepth to 2 to view subsections in ToC
\usepackage{titletoc}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% EDIT P. Dreuw: load minitoc always in last position
...
\renewcommand*{\occasion}{Seminar medical image processing -- MedBV05 \\ this occasion title can be very long } % (used for \TitlePage)
...
\renewcommand*{\authorshort}{Deselaers / Dreuw:\xspace}                       % all the authors of the work, should be short (used for \lfoot)
...
\item Images can be scaled relatively to the \texttt{\textbackslash textwidth} or \texttt{\textbackslash linewidth} of the slides:
  \begin{center}
    \includegraphics[width=.2\textwidth]{salientpoints}
    \includegraphics[width=.2\linewidth]{grid}
  \end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\NewPage\subsection{Playing Audio Files}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\NewPage\subsection{Playing Video Files}
\hypertarget{sli:hyperlinks_video}
\vfill
%
%\renewcommand*{\defaultvideodir}{} 
% -> if set, you could write e.g. \videofilelogobox{/u/wherever/you/want/i6gesture.avi} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\NewPage\subsection{Page Numbering}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\NewPage\subsection{Changing Logos}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\NewPage\subsection{Page Titles}
\renewcommand*{\topleftlogo}{} %% remove the third logo defined at the previous slide
...
\begin{table}      
  ...
  \begin{tabular}{@{} l l D{2.2} D{2.2} @{}}
    \toprule 
    \multicolumn{1}{@{}N}{Densities}  & \multicolumn{1}{N}{Pooling}  & \multicolumn{1}{N}{Gaussian ER[\%]} & \multicolumn{1}{N@{}}{Laplacian ER[\%]} \\ 
...
\end{enumerate}
\vfill
Use the package \texttt{\textbackslash usepackage\{cite\}} to sort your slides
\vfill 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\NewPage\subsection{\textcolor{red}{C}\textcolor{green}{o}\textcolor{blue}{l}\textcolor{red}{o}\textcolor{green}{r}\textcolor{blue}{s}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\NewPage\subsection{Hide Table Columns}
\def\ignore#1\endignore{} 
\newcolumntype{I}{@{}>{\ignore}l<{\endignore}} 
\hypertarget{sli:tricks}
\vfill
Hide complete columns of your tables without changing the table values, e.g. hide a result of a WER\% table
\vfill
w/o hiding: 
\begin{tabular}{|l|l|l|} 
  \hline
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\NewPage\subsection{Includegraphics with Clip \& Crop}
\vfill
If you want to crop something from an image or a plot (e.g. the title of a plot)
\begin{figure}
  \centering
  \includegraphics{car}
  \quad
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\NewPage\subsection{Phantom vs. Itemize}
\vfill
Phantom: \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\NewPage\subsection{Embedded Fonts}
\vfill
converts \texttt{foo.pdf}, a file \textcolor{red}{w/o} embedded fonts, into \texttt{foo2.pdf}, a file \textcolor{green}{w/} embedded fonts (e.g.\ for IEEE PDF eXpress):
\begin{itemize}
...
\texttt{convert} to convert e.g.\ a JPEG/PNG image into an EPS image.
\vfill

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\NewPage\subsection{\texttt{write18} Hacks}
\vfill
\begin{verbatim}
\makeatletter
\begingroup
