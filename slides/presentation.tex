...
%\begin{description}
%\begin{itemize}
%\item [R. Neal]: Connectionist learning of belief
%networks. \em{Elsevier}.
%\item[] \textbf{Sigmoid belief nets} \cite{neal:1992}
%\item[] \textbf{Variational Autoencoder} \cite{vae:2014} \cite{dlgm:2014}
%\item[] \textbf{Generative adversarial nets} \cite{gan:2014}
%\end{itemize}
%\end{description}
%\vfill
...
\vfill
\begin{itemize}
	\item Use of unlabeled datasets
...
\begin{minipage}[t]{0.5\linewidth}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Evaluation over all possible configurations
		\end{itemize}
	\end{itemize}
\end{minipage}
...
\NewPage\headline{Generative Adversarial Nets: Latent Space Interpolation}
	\begin{center}
		\vfill
		\includegraphics[width=\linewidth]{images/bedroom_latent_interpolation}\\
		\vfill
...
\begin{itemize}
	...
	\begin{itemize}
		\item Intuitive idea
		\item Similar to human learning
