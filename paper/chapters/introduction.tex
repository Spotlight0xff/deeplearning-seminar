...
\end{figure}
%Generative modeling is a wide field involving capturing an unknown data distribution.\\

% TODO (kinda similar to the first sentences in the introduction (and even abstract as well)
...
% "learning deep generative models" gives these arguments!
...
image denoising~\cite{generative_denoising:2013}, % TODO: citation
...
\label{fig:dgm}
  \medskip
  \small
  \todo[inline]{arrow indicate stochastic dependency}
