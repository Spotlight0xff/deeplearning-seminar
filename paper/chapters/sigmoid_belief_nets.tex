...
\label{sec:sbn}
Sigmoid Belief Networks (SBN) \cite{neal:1992} have been proposed in 1992 by R. M. Neal and thus are one of the earliest generative models and also predating all other presented models presented in this paper.
