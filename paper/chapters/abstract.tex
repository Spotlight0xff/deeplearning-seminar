...
After discussing generative modeling in general and its applications, we then introduce the sigmoid belief network which is a simple generative architecture.
Then we focus on two more recently proposed architectures: the variational autoencoders (VAE), and generative adversarial networks (GAN).
We discuss the key idea of both models and their respective learning and training procedure, including variational inference and adversarial training for VAE and GAN respectively.
