Instead of using VAEs in a completely unsupervised manner, oftentimes learning from a dataset where a small subset of datapoints has corresponding labels.
