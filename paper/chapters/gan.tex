...
This formulation allows us to define the convergence as equation \ref{zerosum_convergence}.
\begin{equation}
...
Combining the objective functions of both generator and discriminator in equation \ref{eq:l_g_2} and \ref{eq:l_d}, respectively yields us the following objective with value function $V(G,D)$.
$$
